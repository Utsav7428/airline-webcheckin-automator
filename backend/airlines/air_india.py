...
async def generate_boarding_pass(pnr: str, last_name: str) -> BoardingPass:
    """
    Generate a boarding pass for Air India flights.
    In a real implementation, this would connect to Air India's API or database.
    """
    ...
    return BoardingPass(
        ...
        pnr=pnr,
        bookingReference=f"AI{random.randint(100000, 999999)}"
    ) 